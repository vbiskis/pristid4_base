...
#' Author: Nikki Biskis
#' Date: 2025-12-1
#' Content: word analysis - word clouds
#' + Figure 11a
#' -----------

source('helpers/help_news.R')
trove_main <- readxl::read_xlsx("data/xls/processed/trove_m_arts.xlsx") 
...
png("figs/fig12/wordcloudtxt.tiff", width = 3000, height = 3000, res = 300)
